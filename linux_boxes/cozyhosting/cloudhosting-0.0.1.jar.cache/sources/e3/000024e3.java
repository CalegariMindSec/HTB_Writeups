...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/aspectjweaver-1.9.19.jar:org/aspectj/weaver/loadtime/definition/LightXMLParser.class */
public class LightXMLParser {
    ...
    private ArrayList<LightXMLParser> children = new ArrayList<>();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x00f0, code lost:
        if (checkCDATA(r0) == false) goto L67;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:63:0x01fb, code lost:
        if (checkLiteral(r0) != false) goto L58;
     */

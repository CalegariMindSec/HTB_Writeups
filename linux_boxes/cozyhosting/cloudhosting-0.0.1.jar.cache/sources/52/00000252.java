...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/logback-core-1.4.5.jar:ch/qos/logback/core/subst/Node.class */
public class Node {
    Type type;
    Object payload;
    Object defaultPart;
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/logback-core-1.4.5.jar:ch/qos/logback/core/subst/Node$Type.class */
    public enum Type {
        LITERAL,
        VARIABLE
    }
    ...
    public String toString() {
        switch (this.type) {
            case LITERAL:
                return "Node{type=" + String.valueOf(this.type) + ", payload='" + String.valueOf(this.payload) + "'}";
            case VARIABLE:
                ...
                String r = "Node{type=" + String.valueOf(this.type) + ", payload='" + payloadBuf.toString() + "'";
                if (this.defaultPart != null) {

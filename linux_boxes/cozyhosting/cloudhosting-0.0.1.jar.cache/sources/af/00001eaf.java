...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/tomcat-embed-el-10.1.5.jar:org/apache/el/util/Validation.class */
public class Validation {
    private static final String[] invalidIdentifiers = {BeanDefinitionParserDelegate.ABSTRACT_ATTRIBUTE, StandardAssertTagProcessor.ATTR_NAME, "boolean", "break", "byte", StandardCaseTagProcessor.ATTR_NAME, "catch", EscapedFunctions.CHAR, "class", "const", "continue", "default", "do", "double", "else", "enum", "extends", "false", "final", "finally", "float", "for", "goto", StandardIfTagProcessor.ATTR_NAME, "implements", DefaultBeanDefinitionDocumentReader.IMPORT_ELEMENT, "instanceof", "int", "interface", "long", "native", "new", "null", "package", "private", "protected", "public", "return", "short", "static", "strictfp", "super", StandardSwitchTagProcessor.ATTR_NAME, "synchronized", "this", "throw", "throws", "transient", "true", "try", "void", "volatile", "while"};

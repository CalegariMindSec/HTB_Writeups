...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/HikariCP-5.0.1.jar:com/zaxxer/hikari/util/ClockSource.class */
public interface ClockSource {
    ...
    public static final String[] TIMEUNIT_DISPLAY_VALUES = {"ns", "µs", BaseUnits.MILLISECONDS, "s", ANSIConstants.ESC_END, "h", DateTokenConverter.CONVERTER_KEY};
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/HikariCP-5.0.1.jar:com/zaxxer/hikari/util/ClockSource$Factory.class */
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/HikariCP-5.0.1.jar:com/zaxxer/hikari/util/ClockSource$MillisecondClockSource.class */
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/HikariCP-5.0.1.jar:com/zaxxer/hikari/util/ClockSource$NanosecondClockSource.class */

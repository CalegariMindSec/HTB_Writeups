...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/lombok-1.18.26.jar:lombok/delombok/FormatPreferences.SCL.lombok */
public final class FormatPreferences {
    ...
    public FormatPreferences(Map<String, String> preferences, String indent, Boolean filledEmpties) {
        ...
        if (indent_ != null && !"scan".equalsIgnoreCase(indent_)) {
            ...
            indent = indent_.replace("\\t", SyslogAppender.DEFAULT_STACKTRACE_PATTERN).replace("tab", SyslogAppender.DEFAULT_STACKTRACE_PATTERN);
        }

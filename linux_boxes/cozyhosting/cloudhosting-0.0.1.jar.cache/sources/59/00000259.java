...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/logback-core-1.4.5.jar:ch/qos/logback/core/subst/Token.class */
public class Token {
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/logback-core-1.4.5.jar:ch/qos/logback/core/subst/Token$Type.class */
    public enum Type {
        LITERAL,
        START,
        CURLY_LEFT,
    ...
    public String toString() {
        String result = "Token{type=" + String.valueOf(this.type);
        if (this.payload != null) {

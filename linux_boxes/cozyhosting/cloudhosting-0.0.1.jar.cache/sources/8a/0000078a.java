...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/HikariCP-5.0.1.jar:com/zaxxer/hikari/util/FastList.class */
public final class FastList<T> implements List<T>, RandomAccess, Serializable {
    ...
    public boolean add(T element) {
        ...
        T[] newElementData = (T[]) ((Object[]) Array.newInstance(this.clazz, newCapacity));
        System.arraycopy(this.elementData, 0, newElementData, 0, oldCapacity);
        int i2 = this.size;
        this.size = i2 + 1;
        newElementData[i2] = element;

...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/lombok-1.18.26.jar:lombok/patcher/scripts/WrapperMethodDescriptor.SCL.lombok */
public class WrapperMethodDescriptor {
    ...
    public String getWrapperName() {
        return "$lombok$$wrapper$" + this.count + PropertiesBeanDefinitionReader.CONSTRUCTOR_ARG_PREFIX + this.name;
    }

    public int hashCode() {
        int result = (31 * 1) + this.count;
        return (31 * ((31 * ((31 * ((31 * ((31 * ((31 * result) + (this.itf ? Oid.NUMERIC_ARRAY : 1237))) + (this.name == null ? 0 : this.name.hashCode()))) + this.opcode)) + (this.owner == null ? 0 : this.owner.hashCode()))) + (this.targetDescriptor == null ? 0 : this.targetDescriptor.hashCode()))) + (this.wrapperDescriptor == null ? 0 : this.wrapperDescriptor.hashCode());
    }

...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/hibernate-core-6.1.6.Final.jar:org/hibernate/engine/jdbc/env/spi/AnsiSqlKeywords.class */
public final class AnsiSqlKeywords {
    ...
    private AnsiSqlKeywords() {
        Set<String> keywordsSql2003 = new HashSet<>();
        ...
        keywordsSql2003.add(EscapedFunctions.SQL_TSI_DAY);
        ...
        keywordsSql2003.add(EscapedFunctions.SQL_TSI_HOUR);
        ...
        keywordsSql2003.add(EscapedFunctions.SQL_TSI_MINUTE);
        keywordsSql2003.add("MODIFIES");
        keywordsSql2003.add("MODULE");
        keywordsSql2003.add(EscapedFunctions.SQL_TSI_MONTH);
        ...
        keywordsSql2003.add(JoranConstants.NULL);
        ...
        keywordsSql2003.add(EscapedFunctions.SQL_TSI_SECOND);
        ...
        keywordsSql2003.add(DocType.DEFAULT_TYPE_SYSTEM);
        ...
        keywordsSql2003.add(EscapedFunctions.SQL_TSI_YEAR);

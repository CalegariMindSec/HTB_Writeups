...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/tomcat-embed-core-10.1.5.jar:org/apache/catalina/util/Strftime.class */
public class Strftime {
    ...
    static {
        ...
        translate.put("M", "mm");
        translate.put(JdbcLiteralFormatterCharacterData.NATIONALIZED_PREFIX, ScriptUtils.FALLBACK_STATEMENT_SEPARATOR);
        translate.put("p", "a");
        translate.put(ResolvedType.PARAMETERIZED_TYPE_IDENTIFIER, "a");
        translate.put("r", "hh:mm:ss a");
        translate.put("R", "HH:mm");
        translate.put("S", "ss");
        translate.put("t", SyslogAppender.DEFAULT_STACKTRACE_PATTERN);
        translate.put("T", DateTimeUtils.FORMAT_STRING_TIME);
        translate.put("V", "ww");
        translate.put("X", DateTimeUtils.FORMAT_STRING_TIME);

...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/classmate-1.5.1.jar:com/fasterxml/classmate/Annotations.class */
public class Annotations implements Serializable, Iterable<Annotation> {
    ...
    public Annotation[] asArray() {
        ...
        return (Annotation[]) this._annotations.values().toArray(new Annotation[0]);
    }

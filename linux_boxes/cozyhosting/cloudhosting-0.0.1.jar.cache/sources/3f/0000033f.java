...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/jackson-core-2.14.1.jar:com/fasterxml/jackson/core/io/CharTypes.class */
public final class CharTypes {
    ...
    static {
        ...
        for (int c = 128; c < 256; c++) {
            if ((c & Constants.CHECKCAST_QUICK) == 192) {
                i = 2;
            } else if ((c & 240) == 224) {
                i = 3;
            } else if ((c & 248) == 240) {
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/jackson-core-2.14.1.jar:com/fasterxml/jackson/core/io/CharTypes$AltEscapes.class */

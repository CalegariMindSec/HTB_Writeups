...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/lombok-1.18.26.jar:lombok/permit/Permit.SCL.lombok */
public class Permit {
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/lombok-1.18.26.jar:lombok/permit/Permit$Fake.SCL.lombok */
    static class Fake {
        boolean override;
    ...
    public static <T> T newInstance(Constructor<T> c, Object... args) throws IllegalAccessException, InvocationTargetException, InstantiationException {
        return (T) newInstance(null, c, args);
    }
    ...
    public static <T> T newInstanceSneaky(Constructor<T> c, Object... args) {
        return (T) newInstanceSneaky(null, c, args);
    }

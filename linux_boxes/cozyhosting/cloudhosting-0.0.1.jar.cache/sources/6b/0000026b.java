...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/logback-core-1.4.5.jar:ch/qos/logback/core/util/COWArrayList.class */
public class COWArrayList<E> implements List<E> {
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [T[], E[]] */
    @Override // java.util.List, java.util.Collection

...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/jaxb-core-4.0.1.jar:org/glassfish/jaxb/core/WhiteSpaceProcessor.class */
public abstract class WhiteSpaceProcessor {
    ...
    protected static boolean isWhiteSpaceExceptSpace(char ch2) {
        if (ch2 >= ' ') {
            return false;
        }
        return ch2 == '\t' || ch2 == '\n' || ch2 == '\r';

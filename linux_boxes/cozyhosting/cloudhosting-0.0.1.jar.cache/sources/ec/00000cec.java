...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/lombok-1.18.26.jar:lombok/core/SpiLoadUtil.SCL.lombok */
public class SpiLoadUtil {
    ...
    private static void readServicesFromUrl(Collection<String> list, URL url) throws IOException {
        ...
        if (in != null) {
            try {
                r = new BufferedReader(new InputStreamReader(in, UriEscape.DEFAULT_ENCODING));
                while (true) {

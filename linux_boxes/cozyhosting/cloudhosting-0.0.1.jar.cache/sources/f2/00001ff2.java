...
public class CharsetCache {
    ...
    public CharsetCache() {
        ...
        for (String charsetName2 : LAZY_CHARSETS) {
            addToCache(charsetName2, DUMMY_CHARSET);
        }
    }
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/tomcat-embed-core-10.1.5.jar:org/apache/tomcat/util/buf/CharsetCache$DummyCharset.class */

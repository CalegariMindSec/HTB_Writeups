...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/aspectjweaver-1.9.19.jar:org/aspectj/util/PartialOrder.class */
public class PartialOrder {

    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/aspectjweaver-1.9.19.jar:org/aspectj/util/PartialOrder$PartialComparable.class */
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/aspectjweaver-1.9.19.jar:org/aspectj/util/PartialOrder$SortObject.class */
    public static class SortObject<T extends PartialComparable> {
        T object;
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/aspectjweaver-1.9.19.jar:org/aspectj/util/PartialOrder$Token.class */

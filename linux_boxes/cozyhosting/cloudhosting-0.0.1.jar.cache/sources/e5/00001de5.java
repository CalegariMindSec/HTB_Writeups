...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/tomcat-embed-core-10.1.5.jar:org/apache/coyote/ajp/Constants.class */
public final class Constants {
    ...
    private static final String[] headerTransArray = {"accept", "accept-charset", "accept-encoding", "accept-language", SpringSecurityExpressionObjectFactory.AUTHORIZATION_EXPRESSION_OBJECT_NAME, "connection", "content-type", "content-length", "cookie", "cookie2", "host", "pragma", "referer", "user-agent"};

...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/tomcat-embed-core-10.1.5.jar:org/apache/tomcat/util/buf/Utf8Encoder.class */
    ...
    private CoderResult encodeHasArray(CharBuffer in, ByteBuffer out) {
        ...
        while (x < pos + rem) {
            ...
            if (jchar <= 127) {
                ...
                bArr[i4] = (byte) (Constants.CHECKCAST_QUICK + ((jchar >> 12) & 15));
        ...
        while (pos < limit) {
            ...
            try {
                ...
                if (jchar <= 127) {
                    ...
                    out.put((byte) (Constants.CHECKCAST_QUICK + ((jchar >> 12) & 15)));

...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/lombok-1.18.26.jar:lombok/bytecode/ClassFileMetaData.SCL.lombok */
public class ClassFileMetaData {
    ...
    private String decodeString(int pos, int size) {
        ...
        while (pos < end) {
            ...
            } else if ((first & Constants.CHECKCAST_QUICK) == 192) {
                int x = (first & 31) << 6;
                pos++;

...
/* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/attoparser-2.0.6.RELEASE.jar:org/attoparser/config/ParseConfiguration.class */
public final class ParseConfiguration implements Serializable, Cloneable {
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/attoparser-2.0.6.RELEASE.jar:org/attoparser/config/ParseConfiguration$ElementBalancing.class */
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/attoparser-2.0.6.RELEASE.jar:org/attoparser/config/ParseConfiguration$ParsingMode.class */
    ...
    public static ParseConfiguration htmlConfiguration() {
        try {
            return DEFAULT_HTML_PARSE_CONFIGURATION.m2273clone();
    ...
    public static ParseConfiguration xmlConfiguration() {
        try {
            return DEFAULT_XML_PARSE_CONFIGURATION.m2273clone();
        } catch (CloneNotSupportedException e) {
            throw new IllegalStateException(e);
        }
    }
    ...
    /* renamed from: clone */
    public ParseConfiguration m2273clone() throws CloneNotSupportedException {
        ...
        conf.prologParseConfiguration = this.prologParseConfiguration.m2276clone();
        return conf;
    }

    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/attoparser-2.0.6.RELEASE.jar:org/attoparser/config/ParseConfiguration$PrologPresence.class */
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/attoparser-2.0.6.RELEASE.jar:org/attoparser/config/ParseConfiguration$UniqueRootElementPresence.class */
    ...
    /* loaded from: cloudhosting-0.0.1.jar:BOOT-INF/lib/attoparser-2.0.6.RELEASE.jar:org/attoparser/config/ParseConfiguration$PrologParseConfiguration.class */
    public static class PrologParseConfiguration implements Serializable, Cloneable {
        ...
        /* renamed from: clone */
        public PrologParseConfiguration m2276clone() throws CloneNotSupportedException {
